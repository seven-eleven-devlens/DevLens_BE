...
public enum ErrorCode {
    ...
    DUPLICATE_USER_ID(1006, HttpStatus.BAD_REQUEST,"이미 존재하는 ID 입니다."),
    DUPLICATE_EMAIL(1007, HttpStatus.BAD_REQUEST,"이미 존재하는 이메일 입니다."),
    INVALID_PASSWORD_LENGTH(1008, HttpStatus.BAD_REQUEST,"비밀번호는 8자 이상, 20자 이하로 입력해야 합니다."),
    INVALID_PASSWORD_FORMAT(1009, HttpStatus.BAD_REQUEST,"비밀번호는 숫자와 특수문자를 포함해야 합니다."),
