...
public class FileMetadata {
    ...
    @Column(name = "file_category", length = MAX_FILE_CATEGORY_NAME_LENGTH, nullable = false)
    ...
    public static FileMetadata registerFile(FileCategory fileCategory, Long referenceId, String fileDisplayTitle,
                                            String fileTitle, String contentType, String fileFormat,
                                            Double fileSize, String filePath) {
        FileMetadata fileMetadata = new FileMetadata();
        fileMetadata.fileCategory = fileCategory;
        fileMetadata.referenceId = referenceId;
        fileMetadata.fileDisplayTitle = fileDisplayTitle;
        fileMetadata.fileTitle = fileTitle;
